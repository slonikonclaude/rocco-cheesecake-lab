...
/** Цвет адресной строки — `--color-cream` из globals.css (метаданные не читают CSS-переменные). */
export const THEME_COLOR = "#f5efe8";
...
export function buildMetadata(locale: Locale): Metadata {
  ...
  // Превью соцсетей — public/og.jpg 1200×630 из студийного кадра тортов: JPEG, а не WebP, — его понимают все мессенджеры.
